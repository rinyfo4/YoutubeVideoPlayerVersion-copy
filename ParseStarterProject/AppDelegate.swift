...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Parse.setApplicationId("XNudlS68T8DnMZiHd4KIfGd4QjncHqIOzwpdwD14", clientKey: "fxniumJL5cs35RQRXpCf6uUYIy2V14fYTJ89NDXf")
       
                var tableVC:FeedTableViewController = FeedTableViewController(className: "ProductInfo")
        let headerImage: UIImage = UIImage(named: "header.png")!
